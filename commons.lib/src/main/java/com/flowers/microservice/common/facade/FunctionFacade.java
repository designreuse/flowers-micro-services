...
import com.flowers.microservice.common.constants.TimeZones;
import com.flowers.microservice.common.exception.Handler;
import com.flowers.microservice.common.model.beans.Model;
import com.flowers.microservice.common.model.beans.NullObject;
...
public class FunctionFacade {
	 ...
	 */    
	public static String printMap(@Nonnull final Map<String, String> map) {
	 ...
	 */
	public static <T> List<T> filter(@Nonnull final Predicate<T> predicate, @Nonnull final List<T> source) {
	 ...
	 * @returns The string <code>String</code> representation of the Set data type
	 */	
	public static String printList(@Nonnull final List<?> list) {
	 ...
	 * @returns The string <code>String</code> representation of the Set data type
	 */	
	public static String printSet(@Nonnull final Set<?> set) {
	 ...
	 */	
	public static String printJsonMap(@Nonnull final Map<String, ?> map) {
	 ...
	 */	
	public static String formatDateAsIso8601(final @Nonnull String inputDateAsString, final @Nonnull String inputStringFormat) throws ParseException {
	 ...
	 * @returns the string <code>String</code> representation of the date in ISO 8601 format
	 */	
	public static String formatDateAsIso8601(final @Nonnull Date date) throws ParseException {
	 ...
	 * the data that is to be pushed to the destination endpoint.
	 ...
	 */
	public static String getJsonModeltoString(@Nonnull final Model model){

		return  JsonSanitizer.sanitize(Handler.unchecked(() -> new ObjectMapper().writeValueAsString(model)).get());
	}	
	 ...
	 */
	public static String getJsonRootValue(@Nonnull final Object object){
	 ...
	 */
	public static <T,R> List<R> map(@Nonnull final Function<T,R> function, @Nonnull final List<T> source){
	 ...
	 */
	public static <T, R> Supplier<R> bind(@Nonnull final Function<T,R> fn, @Nonnull final T val) {
	    return () -> fn.apply(val);
	}
	 ...
	 */
	public static <X, Y, Z> Map<Z, Y> transformKey(@Nonnull final Map<? extends X, ? extends Y> input,
			@Nonnull final Function<X, Z> function) {
	 ...
	 * @return map <code>Map</code> with output values 
	 */
	public static <X, Y, Z> Map<X, Z> transformValue(@Nonnull final Map<? extends X, ? extends Y> input,
			@Nonnull final Function<Y, Z> function) {
	    return input.keySet().parallelStream()
	 ...
	 */
    public static <T> void copyListElements(final @Nonnull List<T> list, @Nonnull Supplier<Collection<T>> targetCollection) {
     ...
     */
    public static <T,S> List<T> convertModelList(@Nonnull final List<S> list, @Nonnull final Class<T> klass) {
     ...
     */
    public static <T> void initializeModelList(@Nonnull List<T> list) {
     ...
     */
	public static <T> List<T> sortListByFunction(@Nonnull final List<T> list, @Nonnull final Function<T, String> function) {	
